...
Over 28 months I authored 20,892 of 21,632 commits across these platforms — schema and RLS through payments and on-chain settlement to the UI a customer touches. **Most of that work lives in private client repositories**, so the graph here shows the public slice.
